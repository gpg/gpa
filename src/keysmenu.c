...
/* commands */
  ...
  gpa_widget_show (
    windowTrust, parent, _( "keys_openPublic_editTrust.tip" )
  );
...
/* commands */
  ...
  *keyEdited = g_list_append ( *keyEdited, keyID );
  ...
  gtk_signal_connect_object (
    ...
    GTK_SIGNAL_FUNC ( keys_openPublic_editTrust ), (gpointer) paramTrust
  );
  ...
  gpa_widget_show (
    windowKey, windowPublic, _( "keys_openPublic_editKey.tip" )
  );
...
/* commands */
  ...
  gpapa_public_key_send_to_server (
    key, global_keyserver, gpa_callback, windowPublic
  );
...
void keys_openPublic_receive_receive ( gpointer param ) {
/* var */
  gpointer *localParam;
  GtkWidget *entryKey;
...
/* commands */
  ...
  gpa_connect_by_accelerator (
    GTK_LABEL ( labelKey ), entryKey, accelGroup, _( "_Key ID: " )
  );
  ...
  gtk_box_pack_start (
    GTK_BOX ( vboxReceive ), hButtonBoxReceive, FALSE, FALSE, 0
  );
  gtk_container_add ( GTK_CONTAINER ( windowReceive ), vboxReceive );
  gpa_widget_show (
    windowReceive, windowPublic, _( "keys_openPublic_receive.tip" )
  );
  gtk_widget_grab_focus ( entryKey );
} /* keys_openPublic_receive */

void keys_openPublic_exportTrust_export ( gpointer param ) {
/* var */
  gpointer *localParam;
  GtkWidget *checkerArmor;
  GpaWindowKeeper *keeperTrust;
...
/* commands */
  ...
  gpa_widget_show (
    selectTrust, windowPublic, _( "keys_openPublic_exportTrust.tip" )
  );
...
/* commands */
  ...
  *rowsSelected = NULL;
  ...
  gtk_signal_connect_object (
    GTK_OBJECT ( buttonReceive ), "clicked",
    GTK_SIGNAL_FUNC ( keys_openPublic_receive ), (gpointer) windowPublic
  );
  gtk_table_attach (
  ...
  gtk_signal_connect_object (
    ...
    GTK_SIGNAL_FUNC ( keys_openPublic_delete ), (gpointer) paramDelete
  );
  gtk_table_attach (
  ...
  gpa_widget_show (
    windowPublic, global_windowMain, _( "keys_openPublic.tip" )
  );
...
/* commands */
  ...
  *rowsSelected = NULL;
  ...
  gpa_widget_show (
    windowSecret, global_windowMain, _( "keys_openSecret.tip" )
  );
...
/* commands */
  ...
  *expiryDate = NULL;
  ...
  gpa_widget_show (
    windowGenerate, global_windowMain, _( "keys_generateKey.tip" )
  );
} /* keys_generateKey */
...
/* commands */
  ...
  *keysSelected = NULL;
  ...
  gpa_widget_show (
    windowRevoc, global_windowMain, _( "keys_generateRevocation.tip" )
  );
...
/* commands */
  ...
  gpa_widget_show (
    windowImport, global_windowMain, _( "keys_importOwnertrust.tip" )
  );
