...
GpaFile *
gpa_file_new (gchar * anIdentifier, gchar * aName)
{
/* objects */
  GpaFile *fileNew;
/* commands */
...
gchar *
gpa_file_get_identifier (GpaFile * aFile)
{
  if (aFile != NULL)
...
gchar *
gpa_file_get_name (GpaFile * aFile)
{
  if (aFile != NULL)
    return (aFile->name);
  else
...
gboolean
gpa_file_is_selected (GpaFile * aFile)
{
  if (aFile != NULL)
...
void
gpa_file_set_selected (GpaFile * aFile, gboolean value)
{
  if (aFile != NULL)
